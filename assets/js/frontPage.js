...
<p><span>${rating[Math.round(element.rating.average)][
...
<h4>${element.name}</h4>
    ...
    `;
      ...
      <div id="modalRightDiv">
        <h6>${apiData[element.id].name} <span>${apiData[element.id].network.name
            }</span></h6>
        <p>${apiData[element.id].summary}</p>
        <p>${apiData[element.id].genres}</p>
        <p>${apiData[element.id].runtime} min</p>
        <p>${rating[Math.round(apiData[element.id].rating.average)][
